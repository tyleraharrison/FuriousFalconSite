...
?>
<html>
<title>Furious Falcons - Emergency Contact Form</title>
<meta charset="UTF-8">
...
<body class="w3-black">
  ...
  <div class="w3-padding-large" id="wrapper">
    <div class="w3-content ff-title">
      <h1>Furious Falcons Emergency Contact</h1>
    </div>
    ...
    <div class="w3-content" id="formContent">
      <p class="w3-justify w3-text-grey">This is a very important form that must be filled out for your participation for the upcoming FIRST Robotics Season. Please consult your parent(s)/gardian(s) when completing this form.</p>
      <p class="error"></p>
